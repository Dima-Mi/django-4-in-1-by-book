...
def post_list(request, tag_slug=None):  # функция-обработчик
    ...
    paginator = Paginator(object_list, 5)  # по 10 записей
    ...
    try:
        ...
        # если номер страницы больше, чем общее кол-во, возвращаем последнюю
